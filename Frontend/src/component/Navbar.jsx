...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between py-5 font-medium'>
        ...
        <Link to='/'><img src={assets.logo2} alt="LLL" className='w-16' /> </Link>
        ...
        <Link to='/cart' className='relative'>
          ...
          <p className='absolute right-[-5px] bottom-[28px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>2  </p>
        </Link>
