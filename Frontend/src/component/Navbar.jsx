...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-3 font-medium relative'>
      ...
      {/* Top-right icons for larger screens */}
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden z-[999]  bg-white transition-all flex flex-col h-screen ${visible ? 'w-full' : 'w-0'}`}>
        <div className='flex flex-col text-gray-600 flex-grow'>
 ...
 {/* Icons at bottom of sidebar */}
      <div className='flex justify-around items-center py-4 border-t sm:hidden'>
