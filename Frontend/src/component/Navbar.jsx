...
const Navbar = () => {
  ...
  return (
    <div className='z-[999] bg-[#f8fcff] w-full fixed top-0 border-b-2'>
    ...
    <MotionBar/>
      ...
      {/* <p>MENU</p>
      <img src={assets.menu_icon} className='w-5 cursor-pointer' alt="Profile" /> */}
        ...
        {/* Nav Links */}
        <ul className='hidden md:flex gap-5 text-base text-gray-700'>
